...
可以。MCP 支持 Streamable HTTP 传输，Server 可以部署在远程服务器上。但目前 Claude Desktop 主要支持本地 stdio 方式。
...
- **官方支持**：Anthropic 持续维护核心 SDK 和常用 Server
- **社区活跃**：越来越多的开发者贡献 MCP Server
- **应用广泛**：从文件管理到数据库查询，覆盖多种场景
- **工具完善**：Inspector 等工具降低了开发门槛

随着更多 AI 应用支持 MCP，这一协议有望成为 AI 与外部世界交互的标准方式。建议开发者尽早了解和掌握 MCP，为构建更强大的 AI 应用做好准备。
